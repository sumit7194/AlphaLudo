...
os.environ["TD_LUDO_RUN_NAME"] = "ac_v6_1_strategic"

from src.model import AlphaLudoV5
from src.trainer import ActorCriticTrainer
from src.game_player_v6_1 import VectorACGamePlayer
...
def main():
    ...
    model_factory = lambda: AlphaLudoV5(num_res_blocks=10, num_channels=128, in_channels=24)
    model = model_factory()
    print(f"[Train] Architecture: AlphaLudoV6.1 (128ch, 10res, 24in, {model.count_parameters():,} params)")
    model.to(device)

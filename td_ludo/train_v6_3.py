...
# Set V6.1 run name BEFORE any config imports
os.environ["TD_LUDO_RUN_NAME"] = "ac_v6_3_capture"

from td_ludo.models.v6_3 import AlphaLudoV63
from td_ludo.training.trainer_v63 import ActorCriticTrainerV63
from td_ludo.game.players.v6_3 import VectorACGamePlayer
...
def main():
    ...
    # Initialize trainer
    trainer = ActorCriticTrainerV63(model, device, learning_rate=LEARNING_RATE)
    ...
    # Eval-only mode
    if args.eval_only:
        from evaluate_v6_3 import evaluate_model

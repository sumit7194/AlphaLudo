...
The actual logic still lives in td_ludo/debug_gameplay.py and will move
into the td_ludo package in a future cron tick (post-Stage-B9).

Usage from td_ludo/:
    python3 scripts/debug_gameplay.py [args]
"""
import os
import runpy
import sys
...
_LEGACY = os.path.normpath(os.path.join(_HERE, "..", "debug_gameplay.py"))

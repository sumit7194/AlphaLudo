...
The actual logic still lives in td_ludo/evaluate_v6_1.py and will move
into the td_ludo package in a future cron tick (post-Stage-B9).

Usage from td_ludo/:
    python3 scripts/evaluate_v6_1.py [args]
"""
import os
import runpy
import sys
...
_LEGACY = os.path.normpath(os.path.join(_HERE, "..", "evaluate_v6_1.py"))

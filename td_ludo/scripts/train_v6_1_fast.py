...
The actual logic still lives in td_ludo/train_v6_1_fast.py and will move
into the td_ludo package in a future cron tick (post-Stage-B9).

Usage from td_ludo/:
    python3 scripts/train_v6_1_fast.py [args]
"""
import os
import runpy
import sys
...
_LEGACY = os.path.normpath(os.path.join(_HERE, "..", "train_v6_1_fast.py"))
